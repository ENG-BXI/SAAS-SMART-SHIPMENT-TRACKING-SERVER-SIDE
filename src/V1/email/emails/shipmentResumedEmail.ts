export const shipmentResumedEmail = (
  clientEmail: string,
  clientName: string,
  shipment: {
    id: string;
  ...
  subject: `Shipment Resumed — #${shipment.shipmentNumber}`,
...
Your shipment (#${shipment.shipmentNumber}) is now back in transit and operations have resumed.

You can track the latest shipment updates here:
  ...
  <div style="max-width:600px;margin:auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.08);">
    ...
    <div style="padding:30px;">
      ...
      <p style="font-size:14px;color:#4b5563;line-height:1.7;">
        Good news — your shipment is now back in transit and shipment operations have resumed successfully.
      </p>
      ...
      <div style="margin:20px 0;padding:15px;background:#ecfdf5;border-left:4px solid #10b981;border-radius:6px;">
        ...
        <span style="color:#065f46;">In Transit 🚛</span>
      </div>
      ...
      <p style="font-size:14px;color:#4b5563;line-height:1.7;text-align:center;">
        You can continue tracking your shipment progress and latest updates anytime.
      </p>
