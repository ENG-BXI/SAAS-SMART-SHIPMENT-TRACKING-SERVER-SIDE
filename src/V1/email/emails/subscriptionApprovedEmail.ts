export const subscriptionApprovedEmail = (
  ...
  toMail: companyEmail,
  subject: 'Your Subscription Has Been Approved — S3 Tracking System',
...
Your subscription request has been approved and your account has been activated on S3 Tracking System.
  ...
  <div style="max-width:600px;margin:auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 10px 30px rgba(0,0,0,0.08);">
    ...
    <div style="padding:30px;">
      ...
      <p style="font-size:14px;color:#4b5563;line-height:1.7;">
        Your subscription request has been approved and your account has been successfully activated.
        You now have full access to S3 Tracking System.
      </p>
      ...
      <p style="font-size:14px;color:#4b5563;text-align:center;">
        You can now sign in and start managing your shipments immediately.
      </p>
